...
namespace App\ItemType\BudgetPro\HttpResponse;
...
class Item extends ApiItemResponse
{
    public function collectionResponse(): JsonResponse
    {
        ...
        if (
            ...
            $model = new \App\ItemType\BudgetPro\Models\Item();
            ...
            $collection = array_map(
                function ($item) {
                    return (new \App\ItemType\BudgetPro\Transformer\Item(
                        $item,
                        [
    ...
    public function showResponse(int $item_id): JsonResponse
    {
        ...
        $item = (new \App\ItemType\BudgetPro\Models\Item())->single(
            $this->resource_type_id,
            $this->resource_id,
            $item_id,
            $this->request_parameters
