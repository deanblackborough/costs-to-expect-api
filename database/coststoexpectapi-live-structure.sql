...
CREATE TABLE `category` (
  ...
  `resource_type_id` bigint unsigned NOT NULL DEFAULT '1',
...
) ENGINE=InnoDB AUTO_INCREMENT=7228 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=5721 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=5450 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=5376 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `item_type_game` (
  ...
  `game` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `statistics` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `winner` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=4588 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `request_error_log` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `method` char(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `source` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'api',
  `debug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
